...
public class AnimalFrame extends ZooFrame {
	...
	public AnimalFrame(String title) {
		...
		slPanel.putConstraint(SpringLayout.NORTH, btnAquatic, 200, SpringLayout.NORTH, pan);
		slPanel.putConstraint(SpringLayout.WEST, btnAquatic, 90, SpringLayout.WEST, pan);
		pan.add(btnAquatic);
		
		btnMammal = new JButton("Mammal");
		slPanel.putConstraint(SpringLayout.NORTH, btnMammal, 120, SpringLayout.NORTH, pan);
		slPanel.putConstraint(SpringLayout.WEST, btnMammal, 90, SpringLayout.WEST, pan);
		pan.add(btnMammal);
		
		btnInsect = new JButton("Insects");
		slPanel.putConstraint(SpringLayout.NORTH, btnInsect, 80, SpringLayout.NORTH, pan);
		...
		slPanel.putConstraint(SpringLayout.NORTH, btnBird, 40, SpringLayout.NORTH, pan);
